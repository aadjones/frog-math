...
import { hopDuration, playbackRate, nextIndex, MS_PER_PAD, AUDIO_REF_MS } from '../src/frogPhysics';
...
describe('frog physics', () => {
  ...
  it('playbackRate inverts duration and matches reference', () => {
    ...
    expect(playbackRate(2 * MS_PER_PAD)).toBeCloseTo(AUDIO_REF_MS / (2 * MS_PER_PAD));
  });
